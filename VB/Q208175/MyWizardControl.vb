...
Namespace DXSample
	...
	Public Class MyWizardViewInfo
		...
		End Function
		Friend ReadOnly Property AppearancesInternal() As WizardAppearanceCollection
			Get
	...
	Public Class MyWizard97Model
		...
		Private Function GetInteriorHeaderBoundsCore(ByVal page As BaseWizardPage) As Rectangle
			...
			End If
			Dim appearances As WizardAppearanceCollection = (CType(ViewInfo, MyWizardViewInfo)).AppearancesInternal
